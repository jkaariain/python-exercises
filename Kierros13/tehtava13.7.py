...
class Pommikäyttöliittymä:
    def __init__(self):
        ...
        self.__bang_kuva = PhotoImage(file="bang1.gif")
        self.__bomb_kuva = PhotoImage(file="bomb1.gif")
        self.__boom_kuva = PhotoImage(file="boom1.gif")

        self.__pommi_label = Label(self.__pääikkuna, image=self.__bomb_kuva)

        self.__räjäytä_button = Button(self.__pääikkuna,
                                       image=self.__bang_kuva,
