...
class Noppapeli:
    def __init__(self):
        ...
        for i in range(PELAAJIEN_LKM):
            Label(self.__ikkuna, text="Pelaajan "+str(i+1)+" pistetilanne:")\
        ...
        self.__lopetavuoroButton.grid(row=1, column=NOPPIEN_LKM+2, sticky=W+E)
    ...
    def alusta_peli(self):
        ...
        self.__pelaajien_pisteet = [0] * PELAAJIEN_LKM
        self.__pelitilanneteksti = "Vuorossa pelaaja "+str(self.__pelivuoro + 1)
    ...
    def heitä(self):
        ...
        for noppa_label in self.__noppakuvalabelit:
            luku = random.randint(1, 6)
            self.__silmäluvut.append(luku)
            noppa_label.configure(image=self.__noppakuvat[luku-1])
